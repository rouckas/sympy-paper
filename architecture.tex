Software architchture is of central importance in any large software
...
desicions that have heretofore been made, and the provides example
user-facing code as approriate.

\subsection{Basic Usage}

% symbols, various ways to declare them

SymPy requires that all variable names be
defined prior to use because it is built on Python. The following statement
...
structural equality, not mathematical equality. This allows any two
expressions to be tested if they are equal to one another as expression trees,
and not only they are equivalent.
...
this case is an open problem in mathematics.
% TODO: ref
