...
overloading, which mirrors the usual mathematical notation. Note that in Python,
exponentiation is represented by \verb|**|. For instance, the following
Python code creates the expression $(x^2 - 2x + 3)/y$.
...
Importnatly, SymPy expressions are immutable. This simplifies the design of
