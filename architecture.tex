...
same name. However, the user is free to have assigened them to different
...
Expressions are created from symbols using Python mathematical syntax.  This is
made possible by defining methods for performing mathematical operations
between SymPy objects and Python objects.  Note that in Python, exponentiation
is represented by \verb|**|. For instance, the following Python code creates
the expression $(x^2 - 2x + 3)/y$.
