...
\texttt{True}, \texttt{False}, and \texttt{None}.  \texttt{True} is returned if the
SymPy object has the property and \texttt{False} is returned if it doesn't or can't.
For example, \texttt{I.is\_real} and \texttt{I.is\_prime} return
\texttt{False} for imaginary unit \texttt{I}.
