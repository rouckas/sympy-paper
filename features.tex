...
SymPy has an extensive feature set that is too encompassing to cover each topic
in-depth in this paper. Here though, calculus and other bedrock areas receive their
own subsections. Additionally,
